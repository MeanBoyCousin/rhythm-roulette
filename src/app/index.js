...
const myUploads = require('./routes/views/myUploads')
const mySaves = require('./routes/views/mySaves')
const spinView = require('./routes/views/spinView')
...
const getDBStats = require('./routes/spin/getDBStats') // Used to get info from DB such as total releases, total genres, etc.
...
app.use('/', home)
app.use('/user', [myUploads, mySaves, spinView])
app.use('/api', [spin, previousSpin, getDBStats, featured])
